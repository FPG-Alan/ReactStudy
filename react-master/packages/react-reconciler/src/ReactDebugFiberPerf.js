...
// 这里是在测试浏览器兼容性, window 下需要有 performance 对象, performance 对象上需要有 { mark, clearMarks, measure, clearMeasures } 这几个函数
// Performance 是一个HTML5新特性, 可以非常精确的统计页面的表现情况. 
// 祥参 https://www.jianshu.com/p/360fdba19e7c
